        ...
        private void backgroundWorker_DoWork(object sender, DoWorkEventArgs e) {
            switch (m_kernelSize) {
                case 3:
                    ...
                    elapsedTime = Algorithms.ImageConvolution(m_data, m_kernelSize, Kernel.M_Gaussian3x3);
                    break;
                case 5:
                    // Apply algorithm and return execution time
                    elapsedTime = Algorithms.ImageConvolution(m_data, m_kernelSize, Kernel.M_Gaussian5x5);
                    break;
                case 7:
                    // Apply algorithm and return execution time
                    elapsedTime = Algorithms.ImageConvolution(m_data, m_kernelSize, Kernel.M_Gaussian7x7);
                    break;
            }
        }
