...
namespace ImageEdit_WPF.Windows {
    ...
    public partial class SaltPepperNoiseColor : Window {
        ...
        /// </summary>
        public SaltPepperNoiseColor(ImageData data, ViewModel vm) {
            m_data = data;
            m_vm = vm;
            m_backgroundWorker = new BackgroundWorker();

            InitializeComponent();
            textboxNoiseColor.Focus();
        ...
        private void ok_Click(object sender, RoutedEventArgs e) {
            try {
                if (textboxNoiseColor.Text.Contains(".")) {
                    probability = double.Parse(textboxNoiseColor.Text, new CultureInfo("en-US"));
                } else if (textboxNoiseColor.Text.Contains(",")) {
                    probability = double.Parse(textboxNoiseColor.Text, new CultureInfo("el-GR"));
                }
